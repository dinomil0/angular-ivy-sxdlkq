...
@Component({
  selector: 'app-crowdfundingtabs',
  templateUrl: './crowdfundingtabs.page.html',
  styleUrls: ['./crowdfundingtabs.page.scss'],
})
export class CrowdfundingtabsPage implements OnInit {
  isAdmin = false;
  isUser : boolean;
  isBusiness : boolean;
  selectedPath = '';
